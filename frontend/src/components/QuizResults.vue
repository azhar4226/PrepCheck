              ...
              <div class="col-auto">
                <div class="d-flex align-items-center gap-4">
                  <div class="text-center">
                    <div class="display-6 fw-bold">{{ results.score }}</div>
                    <small>Score</small>
                  </div>
                  <div class="text-center">
                    <div class="display-6 fw-bold">{{ results.total_marks }}</div>
                    <small>Total</small>
                  </div>
                  <div class="text-center">
                    <div class="display-6 fw-bold">{{ results.percentage }}%</div>
                    <small>Percentage</small>
                  </div>
                  <div class="text-center">
                    <div class="display-6 fw-bold">{{ formatTime(results.time_taken) }}</div>
...
export default {
  ...
  setup(props) {
    ...
    const headerCardClass = computed(() => {
      const percentage = props.results.percentage
    ...
    const shareResults = () => {
      const text = `I just scored ${props.results.percentage}% on a PrepCheck quiz! 🎯`
      if (navigator.share) {
        navigator.share({
