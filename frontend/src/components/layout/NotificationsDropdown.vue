  ...
  <div class="notifications-dropdown">
    ...
    <div class="dropdown">
      ...
      >
        ...
        <span 
          v-if="unreadCount > 0" 
          class="position-absolute badge rounded-pill bg-danger unread-badge"
        >
...
<style scoped>
/* ==========================================================================
   NOTIFICATIONS DROPDOWN COMPONENT STYLES
   ========================================================================== */

/* NOTE: Button styling is handled by parent AppHeader.vue for consistency */
...
/* Custom positioning for unread badge - closer to bell */
.unread-badge {
  top: -8px;
  right: -8px;
  min-width: 18px;
